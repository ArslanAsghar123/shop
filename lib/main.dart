...
import 'package:shopi/screens/auth_screen.dart';
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProxyProvider<Auth, Products>(
          create: (_) => Products('','',[]),
          update:(ctx, auth, data) => Products(auth.token! ,auth.userId!,data!.items == null ? []:data.items),
        ),
        ChangeNotifierProvider.value(
          value: Cart(),
        ),
        ChangeNotifierProxyProvider<Auth, Orders>(
          create: (_) => Orders('',[]),
          update:(ctx, auth, data) => Orders(auth.token!,data!.orders == null ? []:data.orders),
        ),
      ],
      child: Consumer<Auth>(
